...
import {origin_modal_state,origin_form_state} from './state';
...
origin_modal_state.subscribe((data) => {
    update_modal = data;
})

origin_form_state.subscribe((data) => {
    update_form = data;
})
...
const originModalOpen = ( data : any, title : any) => {
  ...
  console.log('title : ', title);
    ...
    if(title === 'add'){
      origin_form_state.update(() => init_form_data);
    ...
    if(title === 'check_delete'){
      let data =  table_data['origin'].getSelectedData();
